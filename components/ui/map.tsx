...
>({
  ...
  useEffect(() => {
    ...
    map.addSource(sourceId, {
      ...
      clusterRadius,
      clusterProperties: {
        // Sum up the userCount from all features in the cluster
        sum_users: ["+", ["get", "userCount"]],
      },
    });
    ...
    map.addLayer({
      ...
      paint: {
        "circle-color": [
          "step",
          ["coalesce", ["get", "sum_users"], ["get", "point_count"]],
          clusterColors[0],
          clusterThresholds[0],
          clusterColors[1],
          clusterThresholds[1],
    ...
    // Add cluster count text layer - shows sum of users instead of location count
    map.addLayer({
